...
interface ApiService {
     ...
     */
    @GET("banner/json")
    fun getBannerData(): Observable<List<BannerData>>

    /**
     * 获取首页置顶的文章
     */
    @GET("article/top/json")
    fun getTopArticles(): Observable<List<Article>>
    ...
    fun getArticles(@Path("pageNo") pageNo: Int): Observable<ListResponse<Article>>

    /**
     * 获取项目类型
     */
    @GET("project/tree/json")
    fun getProjectType(): Observable<List<Index>>
    ...
    fun getArticlesByProjectType(
            ...
            @Query("cid") cid: Int
    ): Observable<ListResponse<Article>>

    /**
     * 获取知识体系
     */
    @GET("tree/json")
    fun getKnowledgeHierarchy(): Observable<List<KnowledgeHierarchy>>
    ...
    fun getOfficialAccounts(): Observable<List<Index>>
    ...
    fun getCollectArticles(@Path("pageNo") pageNo: Int): Observable<ListResponse<Article>>
     ...
     */
    @GET("hotkey/json")
    fun getSearchHotKey(): Observable<List<Index>>
